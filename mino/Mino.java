...
//Superclasse para todos os tetraminos
public class Mino {
  public Block b[] = new Block[4];
  public Block tempB[] = new Block[4];
  int autoDropCount = 0;
  public int direction = 1;// existem as direções 1/2/3/4
  boolean leftCollision, rightCollision, bottomCollision;
  public boolean active = true;
  public boolean deactiving;
  int deactivingCounter = 0;
